...
const generateCard = require('../services/generateCard')


describe('#Divide String test', () => {
    it('Should throw an error if str is not a string', () => {
        assert.throws(() =>{require('../services/divideString')(12312)}, Error)
    })
    it('Should throw an error if the string length is less than 125', () => {
        assert.throws(() => {require('../services/divideString')('lksdajflkdsa')}, Error)
    })
    it('Should return an array with length of 25', () => {
        let arr = require('../services/divideString')('w8ZtkN0bp33ECYnm3YVXhjCmcHGiBe1FsoZByhaGPddcyPPN8EHMypyorwKtMAFfPlBItn27f6o1OLuWoVPaIy0J2oE4TYVUK1eoh0mzlsL95Si3UKPJhGySx24o8');
...
describe('#Random string generation Tests', () => {
    it('Should return an string with length equal to 125', () => {
        let str = require('../services/generateRandomString')(125);
